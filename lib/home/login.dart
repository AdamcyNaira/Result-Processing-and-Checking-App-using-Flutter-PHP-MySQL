  ...
  if(datauser.length==0){
    setState(() {
       ...
       if (response.statusCode==200) {
          ...
          Constants.sharedPref.setString("username", datauser[0]['name']);
          Constants.sharedPref.setString("emaill", datauser[0]['email']);
  ...
  void initState() {
    ...
    // Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => BottomNav()));
       Future.delayed(Duration.zero, () async{
        await     Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => AdminBottomNav()), (Route<dynamic> route) => false);
        //  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => AdminBottomNav()));
          });
    }else{
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'adamcynaira@example.com ',
